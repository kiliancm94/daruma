...
Claude Code's built-in scheduling runs in the cloud, so it can't access your local calendar, MCP servers, or filesystem. Daruma runs on **your machine**, so your agents can use everything you can.
